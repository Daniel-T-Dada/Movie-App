    ...
    return (
        <>
            <footer className="z-50 flex flex-col justify-center items-center w-full bg-[#19305e] rounded-t-3xl p-6 sm:p-8 lg:p-12">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-10 sm:mt-[40px]">
                    <input
                        type="email"
                    ...
                    />
                    <button className="btn rounded-md mt-2 sm:mt-0  h-[45px] sm:h-[50px]  bg-gradient-to-r from-teal-500 to-blue-500 text-white hover:from-pink-500 hover:to-orange-500">
                        Subscribe Now
                    </button>
                </div>


                <div className="flex justify-center mt-6 sm:mt-[60px]">
                    <ul className="flex flex-col sm:flex-row w-full sm:w-8/12 lg:w-5/12 justify-center items-center gap-4 sm:gap-16 text-gray-400">
                        <Link href='/'>
                        ...
                        <Link href='/terms'>
                            <li className="foot  sm:w-[140px]">Terms of Use</li>
                        </Link>
                        <Link href='/faqs'>
